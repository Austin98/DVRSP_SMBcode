...
from src.Dprocess import local_train, local_test
...
def get_args():
    ...
    parser.add_argument("--use_VR", type=bool, default=False)
    parser.add_argument("--use_SF", type=bool, default=True)
    parser.add_argument("--data_label", type=str, default="A3C_base_500K")
    ...
    parser.add_argument("--num_global_steps", type=int, default=5e5)
...
def train(opt):
    ...
    if opt.load_from_previous_stage:  # todo 迁移学习，迁移前一个地图的模型
        if opt.stage == 1:
